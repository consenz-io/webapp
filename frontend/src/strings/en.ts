...
export const en: Record<StringBank, string> = {
  ...
  AGREEMENT_APPROVAL_RULES_DESCRIPTION:
    "Set rules for changing agreement status to approved",
  ...
  AGREEMENT_PUBLIHSED_SUCCESSFULLY:
    "Your agreement has been succesfully published",
  ...
  CATEGORY_AGREMENTS: "{{category}} category Agreements",
