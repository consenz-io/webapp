...
export const he: Partial<Record<StringBank, string>> = {
  ...
  AGREEMENT_PROCESS_RULES_DESCRIPTION:
    'קבעו חוקים עבור קבלת שינויים להסכם עם הוספת סעיפים ואישור גרסאות של סעיפים',
  AGREEMENT_PUBLISHED_SUCCESSFULLY: 'ההסכם שלך פורסם בהצלחה',
  AGREEMENT_UPDATED_AT: 'עדכון אחרון: {{date}}',
  ALL_AGREEMENTS: 'כל ההסכמים',
  ANONYMOUS: 'אנונימי',
  ARCHIVE: 'ארכיון',
  ARCHIVE_EMPTY_MESSAGE: 'זה המקום עבור הסכמים שהועברו לארכיון',
  ...
  DELETE_SECTION_VERSION: 'מחק גרסה של סעיף זה',
